        ...
        <div style={{ display: 'flex' }}>
          ...
          <div style={{ flex: '1' }}>
            <TextField
              ...
              label='Search' value={this.state.searchInput}
              onChange={event => this.searchInputChangeHandler(event)}
            />
            <FormControl component='fieldset'>
              ...
              <RadioGroup
                ...
                onChange={event => this.checkboxChangeHandler(event)}
              >
            ...
            <div>
              <div>
                <TextField
                  ...
                  value={this.state.popFrom}
                  onChange={event => this.populationFromChangeHandler(event)}
                />
              </div>
              <div>
                <TextField
                  type='number'
                  label='Population to'
                  value={this.state.popTo}
                  onChange={event => this.populationToChangeHandler(event)}
                />
              </div>
            </div>
          </div>
